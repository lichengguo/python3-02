...
CREATE TABLE `achievement` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '成绩编号',
  `sid` smallint(5) unsigned NOT NULL COMMENT '学号',
...
CREATE TABLE `course` (
  ...
  `lecturer` smallint(6) NOT NULL COMMENT '主讲老师',
  `address` smallint(5) unsigned DEFAULT NULL COMMENT '教室',
  PRIMARY KEY (`id`)
...
INSERT INTO `course` VALUES (1,' Axure原型策划',1,301),(2,'Javascript',2,305),(3,'AJAX',3,302),(4,'PHP',4,304),(5,'API接口',5,309),(6,'SEO',6,308),(7,'Ci',7,306),(8,'HTML5',8,303),(9,'Ucenter',9,307),(10,'UI设计',10,401),(11,'DiscuzX',11,402),(12,'项目管理',12,403),(13,'DedeCMS',13,404),(14,'HTML',14,405),(15,'Photoshop',15,406),(16,'Memcached',16,407),(17,'YII',17,408),(18,'ThinkPHP',17,409),(19,'负载均衡',18,501),(21,'Magento',19,502),(22,'Css',20,503),(23,'ECOS',21,504),(24,'Mysql',22,505),(25,'Nginx',23,506),(26,'Linux',24,507),(27,'Ecshop',25,508),(28,'Smarty',26,509),(29,'ZenCart',27,510);
...
CREATE TABLE `lecturer` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '讲师编号',
  `lecturer` varchar(50) NOT NULL COMMENT '姓名',
  `sex` tinyint(4) DEFAULT '1' COMMENT '性别[男为1，女为2]',
...
INSERT INTO `lecturer` VALUES (1,'刘老师',NULL,NULL,''),(2,'李老师',NULL,NULL,''),(3,'潘老师',NULL,NULL,''),(4,'黄老师',NULL,NULL,''),(5,'宋老师',NULL,NULL,''),(6,'冯老师',NULL,NULL,''),(7,'林老师',NULL,NULL,''),(8,'丘老师',NULL,NULL,''),(9,'罗老师',NULL,NULL,''),(10,'叶老师',NULL,NULL,''),(11,'周老师',NULL,NULL,''),(12,'贺老师',NULL,NULL,''),(13,'房老师',NULL,NULL,''),(14,'曾老师',NULL,NULL,''),(15,'唐老师',NULL,NULL,''),(16,'吴老师',NULL,NULL,''),(17,'陈老师',NULL,NULL,''),(18,'杜老师',NULL,NULL,''),(19,'郑老师',NULL,NULL,''),(20,'何老师',NULL,NULL,''),(21,'易老师',NULL,NULL,''),(22,'简老师',NULL,NULL,''),(23,'曹老师',NULL,NULL,''),(24,'钟老师',NULL,NULL,''),(25,'白老师',NULL,NULL,''),(26,'江老师',NULL,NULL,''),(27,'关老师',NULL,NULL,'');
...
CREATE TABLE `student` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '学号',
  `name` varchar(50) NOT NULL COMMENT '姓别',
  `sex` tinyint(4) DEFAULT '1' COMMENT '性别[男为1，女为2]',
  `class` smallint(5) unsigned DEFAULT NULL COMMENT '班级',
  `age` tinyint(3) unsigned DEFAULT NULL COMMENT '年龄',
  `descrption` varchar(2000) DEFAULT NULL COMMENT '个人简介',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2016-09-29 12:17:50
